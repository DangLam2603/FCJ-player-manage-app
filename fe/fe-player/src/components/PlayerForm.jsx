    ...
    const fetchCategories = async () => {
      try {
        const response = await axios.get(
          "http://elb-player-be-env.eba-2cqh3pfp.ap-southeast-1.elasticbeanstalk.com/api/player/categories"
        );
  ...
  useEffect(() => {
    const fetchPlayer = async () => {
      ...
      if (playerId) {
        try {
          const response = await axios.get(
            `http://elb-player-be-env.eba-2cqh3pfp.ap-southeast-1.elasticbeanstalk.com/api/player/${playerId}`,
            {
              headers: {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (playerId) {
        ...
        await axios.put(
          `http://elb-player-be-env.eba-2cqh3pfp.ap-southeast-1.elasticbeanstalk.com/api/player`,
          playerData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
